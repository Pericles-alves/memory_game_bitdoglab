...
GPIO BITDOG_OLED_I2C_SDA_PIN (on Pico this is GP4 (pin 6)) -> SDA on display
board
GPIO BITDOG_OLED_I2C_SCL_PIN (on Pico this is GP5 (pin 7)) -> SCL on
display board
...
#define BITDOG_OLED_I2C_DEV        i2c1
#define BITDOG_OLED_I2C_SDA_PIN    14
#define BITDOG_OLED_I2C_SCL_PIN    15
