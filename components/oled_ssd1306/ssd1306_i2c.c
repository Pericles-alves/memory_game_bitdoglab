...
void SSD1306_send_cmd(uint8_t cmd) {
    ...
    i2c_write_blocking(BITDOG_OLED_I2C_DEV, SSD1306_I2C_ADDR, buf, 2, false);
}
...
void SSD1306_send_buf(uint8_t buf[], int buflen) {
    ...
    i2c_write_blocking(BITDOG_OLED_I2C_DEV, SSD1306_I2C_ADDR, temp_buf, buflen + 1, false);
...
void SSD1306_init() {
    ...
    // sent
    i2c_init(BITDOG_OLED_I2C_DEV, SSD1306_I2C_CLK * 1000);
    gpio_set_function(BITDOG_OLED_I2C_SDA_PIN, GPIO_FUNC_I2C);
    gpio_set_function(BITDOG_OLED_I2C_SCL_PIN, GPIO_FUNC_I2C);
    gpio_pull_up(BITDOG_OLED_I2C_SDA_PIN);
    gpio_pull_up(BITDOG_OLED_I2C_SCL_PIN);
